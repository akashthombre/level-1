...
var weaknessFunc = function(weakness){   // weakness as parameter to pass   
	...
	for (x in pokemonList.pokemon){   // iterate through whole object and arrays
      ...
      for(y in pokemonList.pokemon[x].weaknesses){

        if(pokemonList.pokemon[x].weaknesses[y] == weakness){   //conditon

          console.log(pokemonList.pokemon[x].name);    // output in console
